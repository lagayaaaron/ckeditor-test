...
class BorrowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create borrowing" do
    assert_difference("Borrowing.count") do
      post borrowings_url, params: { borrowing: { book_id: @borrowing.book_id, borrowed_on: @borrowing.borrowed_on, borrower_id: @borrowing.borrower_id, returned_on: @borrowing.returned_on } }
    end
  ...
  test "should update borrowing" do
    patch borrowing_url(@borrowing), params: { borrowing: { book_id: @borrowing.book_id, borrowed_on: @borrowing.borrowed_on, borrower_id: @borrowing.borrower_id, returned_on: @borrowing.returned_on } }
